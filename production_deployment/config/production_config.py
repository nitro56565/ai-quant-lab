...
class LiveTradingConfig:
    ...
    max_holding_hours: int = 36                # Clock 3: Maximum Filled Trade Holding Limit (36 Hours Certified Limit for Baseline v2.0)
    ...
    # Strategy Multipliers (Certified Baseline v2.0 — Combo #271)
