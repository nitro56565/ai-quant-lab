...
class DataLoader:
    ...
    def __init__(self, data_dir=None, metadata_dir=None):
        ...
        self.data_dir = Path(data_dir) if data_dir else base_dir / 'realtime_market_streaming' / 'output'
        self.metadata_dir = Path(metadata_dir) if metadata_dir else base_dir / 'realtime_market_streaming' / 'metadata'
