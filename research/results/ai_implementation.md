...
flowchart TD
    ...
    subgraph AI Market Context Subsystem
        ...
        FAR["Permanent Feature Admission Rule Engine (core_machine_learning/feature_admission.py)"]
...
### PHASE 1: Primary Strategy & Meta-Labeling Layer (`strategy_engine/` & `research_and_training_engine/`)
...
#### 1.2 Meta-Labeling Filter (`core_machine_learning/ensemble.py`)
...
### PHASE 6: Permanent Feature Admission Rule (FAR Gatekeeper) (`core_machine_learning/feature_admission.py`)
