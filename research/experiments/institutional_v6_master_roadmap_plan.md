...
* **Goal**: Unify trade geometry definitions across `research_and_training_engine/labeler.py`, `execution_engine/engine.py`, and `scripts/forensic_decision_replay.py`.
...
* **Component**: `live_execution_engine/local_data_workspace/data_validator.py`
...
* **Component**: `research_and_training_engine/governance.py` & `reports/backtest_governance_ledger.db`
...
* **Component**: `research_and_training_engine/macro_features.py`
...
* **Component**: `research_and_training_engine/market_state.py`
...
* **Component**: `research_and_training_engine/thesis_engine.py`
* **Backtest AB Testing Harness**:
...
* **Component**: `research_and_training_engine/adaptive_position_backtest.py`
...
* **Component**: `research_and_training_engine/portfolio_backtest.py`
...
* **Component**: `research_and_training_engine/shadow_backtest.py`
...
> All work will be performed strictly inside `research_and_training_engine/` and `scripts/run_v6_backtest_suite.py`. No changes will be deployed to Paper Trading or Docker until you review the backtest scorecard above and give explicit permission.
