...
def run_simulation(df_eval, p_l, p_s, hmm_arr, trend_p, range_p, initial_cap=10000.0):
    ...
    # Baseline Uses: hmm_arr == 1.0 (Range State)
    req_p_arr = np.where(hmm_arr == 1.0, range_p, trend_p)
...
def main():
    print("Loading Data and Building Features for Canonical True-OOS Probability Threshold Sweep...")
    loader = DataLoader()
    ...
    base_26 = run_simulation(df_eval_26, p_stack_l_26, p_stack_s_26, hmm_te_26, 0.36, 0.42)
