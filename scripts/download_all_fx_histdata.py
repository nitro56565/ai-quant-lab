...
directly into market_data_pipeline/output and metadata directories for Stage 11 Cross-Validation.
"""
...
DATA_DIR = BASE_DIR / "market_data_pipeline" / "output"
METADATA_DIR = BASE_DIR / "market_data_pipeline" / "metadata"
